                ...
                <div className="header flex justify-between sm:gap-20 items-center">
                    <div className="pb-10 sm:pb-12 sm:pl-10 md:pl-20">
                        ...
                        <div className="flex item-center flex-wrap md:flex-nowrap gap-x-5  gap-y-3">
                            <span className="border border-white  bg-white px-5 rounded-full py-1 cursor-pointer">
                                Get A Quote
                            </span>
                            <span className=" border-2 border-white px-5 rounded-full py-1 text-white cursor-pointer">
                                Watch Introduction
                            </span>
                        </div>
                    </div>
